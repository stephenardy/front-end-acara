...
const LandingPageLayoutFooter = () => {
  return (
    <footer className="flex flex-col items-center justify-between bg-slate-900 px-6 py-10 text-center lg:flex-row lg:text-left xl:p-20">
      <Image
      ...
      <div className="mb-4 flex flex-col gap-4 lg:mb-0">
        ...
        <div>
          <h4 className="text-xl text-white">Head Office</h4>
